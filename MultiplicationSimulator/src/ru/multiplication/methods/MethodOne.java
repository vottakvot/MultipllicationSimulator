...
public class MethodOne extends CommonMethods {

	public MethodOne(String A, String B) {
	...
	protected void y1 () {
		...
		mainData.MS1_A_10 = mainData.RG2_9;
		mainData.MS1_A_10 &= Mask_9And10_Bits_Null;
		mainData.MS1_B_10 = mainData.RG2_9;
		mainData.MS1_B_10 <<= 1;
		mainData.MS1_B_10 &= Mask_9Bits;
		mainData.SM1_B_18 &= Mask_0_7_Bits_Null;
	...
	protected void y4 () {
		...
		mainData.SM1_B_18 = ~mainData.SM1_B_18 & Mask_10Bits;
		mainData.SM1_B_18 += 1;
		mainData.SM1_B_18 <<= 8;
	...
	protected void y6 () {
		...
		if((mainData.RG4_18 & Mask_Get_18Bit) == 0)
			mainData.RG4_18 >>= 2;
		else {
			mainData.RG4_18 >>= 2;
			mainData.RG4_18 |= Mask_Get_17_18Bits;
		}
	...
	protected boolean p4 () {
		...
		if((((mainData.RG1_8 & Mask_Get_0Bit) != 0) && ((mainData.RG1_8 & Mask_Get_1Bit) != 0)) ||
				(((mainData.RG1_8 & Mask_Get_1Bit) != 0) && p9()))
			mainData.P4 = true;
		else
			mainData.P4 = false;
	...
	protected boolean p5 () {
		if((((mainData.RG1_8 & Mask_Get_0Bit) != 0) && ((mainData.RG1_8 & Mask_Get_1Bit) != 0) && p9()) ||
				(((mainData.RG1_8 & Mask_Get_0Bit) == 0) && ((mainData.RG1_8 & Mask_Get_1Bit) == 0) && (p9() == false)))
			mainData.P5 = true;
		else
			mainData.P5 = false;
	...
	protected boolean p6 () {
		if((((mainData.RG1_8 & Mask_Get_0Bit) != 0) && ((mainData.RG1_8 & Mask_Get_1Bit) == 0) && (p9() == false)) ||
				(((mainData.RG1_8 & Mask_Get_0Bit) == 0) && ((mainData.RG1_8 & Mask_Get_1Bit) == 0) && p9()))
			mainData.P6 = true;
		else
			mainData.P6 = false;
