...
/*
 * ÏÅÐÂÛÉ ÌÅÒÎÄ ÓÑÊÎÐÅÍÍÎÃÎ ÓÌÍÎÆÅÍÈß Ñ ÔÇ
 */

import java.util.ArrayList;

public class MethodTwo extends CommonMethods {

	public MethodTwo(String A, String B) {
	...
	protected void y7 () {
		mainData.MS1_A_10 = Mask_16Bits & mainData.RG2_9;
	...
	protected void y8 () {
		mainData.MS1_B_10 = Mask_16Bits & mainData.RG2_9;
		mainData.MS1_B_10 <<= 1;
	...
	// Óñòàíîâêà ñèãíàëîâ äëÿ óñëîâíûõ ïåðåõîäîâ
